...
return [
  ...
  'site_url' => "http://ewt",
  'api_url' => "http://ewt/index.php",
  'avatar_url'=>'http://ewt/index.php/picture/avatar',
  // 'picture_url'=>'http://ewt/index.php/picture/index?id=',
  'file_curl_upload_url'=>'http://ewt/index.php/file/curl_upload',
  'upload_path'=>'http://ewt',
  //全局的接口配置信息
  'by_api_config'=>[
      'alg'=>'md5_v3',
  ...
  'database'   =>[
    ...
    // 服务器地址    // 数据库名    // 用户名    // 密码
    // 远程已禁止连接
    // 'hostname'       => '47.94.136.160',
    // 'database'       => 'itboye_ewelisten',
    // 'username'       => 'root',
    // 'password'       => ',eweEWE136799711',
    'hostname'       => '127.0.0.1',
    'database'       => 'itboye_ewelisten_20170622',
    'username'       => 'root',
    'password'       => '1',
